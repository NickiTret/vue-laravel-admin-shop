            ...
            <div class="row">
                <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Наименование" name="title" id="title">
                    </div>
                    <div class="form-group">
                        <textarea cols="50" rows="10" class="form-control" placeholder="Описание" name="description" id="description"></textarea>
                    </div>
                    <div class="form-group">
                        <textarea cols="50" rows="10" class="form-control" placeholder="Контент" name="content" id="content"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Количество на складе" name="count"
                            id="count">
                    </div>
